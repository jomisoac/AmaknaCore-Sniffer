...
using static AmaknaProxy.Hooks.NativeSocketMethods;
using static EasyHook.RemoteHooking;

namespace AmaknaProxy.Hooks
{
    public class Main : IEntryPoint
    {
        ...
        private int _onConnect(IntPtr socket, IntPtr address, int addrSize)
        {
            ...
            _interface.Message($"Intento de conexión en {ipAddress}:{port}, redireccionado a 127.0.0.1:{_redirectionPort}...");
