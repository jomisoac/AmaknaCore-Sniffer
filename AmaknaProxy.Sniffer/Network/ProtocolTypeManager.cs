    ...
    public static class ProtocolTypeManager
    {
        ...
        public static void Initialize()
        {
            ...
            foreach (Type type in asm.GetTypes())
            {
                ...
                if (field != null)
                {
                    // la conversión de uint es necesaria porque el objeto no tiene tipo
                    ...
                    if (ctor == null)
                        throw new System.Exception(string.Format("'{0}' no implementa un constructor sin parámetros", type));
        ...
        public static T GetInstance<T>(ushort id) where T : class
        {
            ...
            {
                ConsoleManager.Error(string.Format("Type <id:{0}> no existe", id));
            }
