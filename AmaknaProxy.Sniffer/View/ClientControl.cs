...
namespace AmaknaProxy.Engine.View
{
    public partial class ClientControl : UserControl
    {
        ...
        private async Task CreateJsonMessages()
        {
            var output = JsonConvert.SerializeObject(Messages, Formatting.Indented);
            using StreamWriter file = new("Messages.json", append: true);
