...
{
    public class ObjectItemMinimalInformationFixed : Item
    {
        ...
        public ObjectItemMinimalInformationFixed()
        {
        }
        
        public ObjectItemMinimalInformationFixed(uint objectGID, Types.ObjectEffect[] effects)
        {
